...
emojiApp.config(["$sceProvider", function (a) {
    ...
    for (c = 0; c < Config.EmojiCategories.length; c++)
        for (h = Config.EmojiCategorySpritesheetDimens[c][1], b = 0; b < Config.EmojiCategories[c].length; b++)
            e = Config.Emoji[Config.EmojiCategories[c][b]], d = e[1][0], f = Math.floor(b / h), g = b % h, i[":" + d + ":"] = [c, f, g, ":" + d + ":"], j[d] = e[0];
    $.emojiarea.spritesheetPath = "img/emojisprite_!.png", $.emojiarea.spritesheetDimens = Config.EmojiCategorySpritesheetDimens, $.emojiarea.iconSize = 30, $.emojiarea.icons = i, $.emojiarea.reverseIcons = j
    ...
    function e(b, e, f) {
        ...
        function j(a) {
            var c = (a.originalEvent || a).target, d = (c || {}).src || "", e = !1;
        ...
        function k(a) {
            ...
            var c, d, e = (a.originalEvent || a).clipboardData, f = e && e.items || [], g = [];
            for (d = 0; d < f.length; d++)"file" == f[d].kind && (c = f[d].getAsFile(), g.push(c));
            g.length > 0 && ErrorService.confirm({type: "FILES_CLIPBOARD_PASTE", files: g}).then(function () {
        ...
        var m = $("textarea", e)[0], n = $("input", e), o = $("#emojibtn", e)[0], p = m, q = ($(m).emojiarea({
            button: o,
            norealTime: !0
        }), $(".emoji-menu", e)[0], $(".emoji-wysiwyg-editor", e)[0]), r = d($("#messageDiv"));
        ...
        $(p).on("keydown", function (c) {
            if (q && i(), 13 == c.keyCode) {
                var d = !1;
                if (t && !c.shiftKey ? d = !0 : t || !c.ctrlKey && !c.metaKey || (d = !0), d)
					return a.cancel(s), h(), b.emojiMessage.replyToUser(), g(), cancelEvent(c)
            }
        });
    ...
    return {scope: {emojiMessage: "="}, link: e}
}]), emojiApp.directive("contenteditable", ["$sce", function (a) {
    return {
        restrict: "A", require: "?ngModel", link: function (a, b, c, d) {
            function e() {
...
}), emojiApp.filter("emoticonToSmiley", function () {
    return function (a) {
		//console.log(a);
        return a ? (Config.rx_emoticons || Config.init_unified(), a.replace(Config.rx_emoticons, function (a) {
            var b = Config.mapemoticons[a];
			//console.log(b);
            if (b) {
				//console.log(b);
               // b = ":" + b + ":";
    ...
    function e() {
        var a, b, c, e = Array.prototype.slice.call(arguments), f = e.pop(), g = [], h = 1 == e.length, i = !0, m = d();
        for (b = 0; b < e.length; b++)if (c = e[b] = m + e[b], "xt_" != c.substr(0, 3) && void 0 !== j[c])g.push(j[c]); else if (l) {
            try {
    ...
    function f(a, b) {
        var c, e, f = {}, g = d();
        for (c in a)if (a.hasOwnProperty(c))if (e = a[c], c = g + c, j[c] = e, e = JSON.stringify(e), l)try {
    ...
    function g() {
        var a, b, c, e = Array.prototype.slice.call(arguments), f = d();
        for ("function" == typeof e[e.length - 1] && (c = e.pop()), a = 0; a < e.length; a++)if (b = e[a] = f + e[a], delete j[b], l)try {
    ...
    var h = "", i = !1, j = {}, k = !!(a.chrome && chrome.storage && chrome.storage.local), l = !k && !!a.localStorage;
    a.ConfigStorage = {prefix: b, noPrefix: c, get: e, set: f, remove: g}
}(this), function (a, b, c) {
    var d = 1, e = 3, f = ["p", "div", "pre", "form"], g = 27, h = 9;
    a.emojiarea = {
        path: "",
        spritesheetPath: "",
        spritesheetDimens: [],
        iconSize: 20,
        icons: {},
        defaults: {button: null, buttonLabel: "Emojis", buttonPosition: "after"}
    };
    ...
    j.restoreSelection = function () {
        ...
        return b.getSelection ? function () {
            var a = b.getSelection(), c = [];
            if (a.rangeCount)for (var d = 0, e = a.rangeCount; e > d; ++d)c.push(a.getRangeAt(d));
            return c
        ...
        return b.getSelection ? function (a) {
            var d, e = b.getSelection(), f = "string" == typeof a ? c.createTextNode(a) : a;
        ...
        if ("undefined" != typeof a && a || (a = {}), "object" == typeof b)for (var c in b)b.hasOwnProperty(c) && (a[c] = b[c]);
        return a
        ...
        ConfigStorage.get("emojis_recent", function (b) {
            b = b || i || [];
            var c = b.indexOf(a);
            return c ? (-1 != c && b.splice(c, 1), b.unshift(a), b.length > 42 && (b = b.slice(42)), void ConfigStorage.set({emojis_recent: b})) : !1
        })
    };
    var k = function () {
    };
    k.prototype.setup = function () {
        ...
        var b, c = this;
        this.options.button ? b = a(this.options.button) : this.options.button !== !1 ? (b = a('<a href="javascript:void(0)">'), b.html(this.options.buttonLabel), b.addClass("emoji-button"), b.attr({title: this.options.buttonLabel}), this.$editor[this.options.buttonPosition](b)) : b = a(""), b.on("click", function (a) {
            n.show(c), a.stopPropagation()
        }), this.$button = b
    }, k.createIcon = function (b, c) {
        var d = b[0], e = b[1], f = b[2], g = b[3], h = a.emojiarea.spritesheetPath, i = c && Config.Mobile ? 26 : a.emojiarea.iconSize, k = -(i * f), l = -(i * e), m = a.emojiarea.spritesheetDimens[d][1] * i, n = a.emojiarea.spritesheetDimens[d][0] * i, o = "display:inline-block;";
    ...
    var m = function (b, d) {
        ...
        var g = this.$editor.text(), h = a.emojiarea.icons;
    ...
    m.prototype.onPaste = function (a) {
        var b, d = (a.originalEvent || a).clipboardData, e = d && d.items || [];
        for (b = 0; b < e.length; b++)if ("file" == e[b].kind)return a.preventDefault(), !0;
        var f = (a.originalEvent || a).clipboardData.getData("text/plain"), g = this;
        ...
        for (var a = [], b = [], c = function () {
            ...
            if (a.nodeType === e)b.push(a.nodeValue); else if (a.nodeType === d) {
                var h = a.tagName.toLowerCase(), i = -1 !== f.indexOf(h);
    ...
    var n = function () {
        ...
        this.visible = !1, this.emojiarea = null, this.$menu = a("<div>"), this.$menu.addClass("emoji-menu"), this.$menu.hide(), this.$itemsTailWrap = a('<div class="emoji-items-wrap1"></div>').appendTo(this.$menu), this.$categoryTabs = a('<table class="emoji-menu-tabs"><tr><td><a class="emoji-menu-tab icon-recent" ></a></td><td><a class="emoji-menu-tab icon-smile" ></a></td><td><a class="emoji-menu-tab icon-flower"></a></td><td><a class="emoji-menu-tab icon-bell"></a></td><td><a class="emoji-menu-tab icon-car"></a></td><td><a class="emoji-menu-tab icon-grid"></a></td></tr></table>').appendTo(this.$itemsTailWrap), this.$itemsWrap = a('<div class="emoji-items-wrap nano mobile_scrollable_wrap"></div>').appendTo(this.$itemsTailWrap), this.$items = a('<div class="emoji-items nano-content">').appendTo(this.$itemsWrap), e.append(this.$menu), Config.Mobile || this.$itemsWrap.nanoScroller({
            ...
            a = a.originalEvent || a;
            for (var c = a.originalTarget || a.target || b; c && c != b;)if (c = c.parentNode, c == d.$menu[0] || d.emojiarea && c == d.emojiarea.$button[0])return;
            d.hide()
    ...
    n.prototype.getTabIndex = function (a) {
        ...
        }), this.currentCategory = a, this.load(a), Config.Mobile || this.$itemsWrap.nanoScroller({scroll: "top"})
    }, n.prototype.onItemSelected = function (a) {
        this.emojiarea.insert(a)
    }, n.prototype.load = function (b) {
        var c = [], d = a.emojiarea.icons, e = a.emojiarea.path, f = this;
        ...
        var a = this.emojiarea.$button, b = a.offset();
        b.top += a.outerHeight(), b.left += Math.round(a.outerWidth() / 2), this.$menu.css({top: b.top, left: b.left})
